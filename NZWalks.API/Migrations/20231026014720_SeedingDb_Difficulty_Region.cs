...
{
    /// <inheritdoc />
    public partial class SeedingDb_Difficulty_Region : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("1b8fa50c-037e-4899-8f13-cefff756815e"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("9a0f21aa-2d1a-4a8f-9712-14d78efc231c"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("d152e8c4-f84b-4aa0-81af-dc98471238bf"));
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1b8fa50c-037e-4899-8f13-cefff756815e"), "NSN", "Nelson", null },
                    { new Guid("9a0f21aa-2d1a-4a8f-9712-14d78efc231c"), "BOP", "Bay Of Plenty", "https://www.pexels.com/ko-kr/photo/3569263/" },
                    { new Guid("d152e8c4-f84b-4aa0-81af-dc98471238bf"), "STL", "Southland", null }
                });
        }
    }
}
